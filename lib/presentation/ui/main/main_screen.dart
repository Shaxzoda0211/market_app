    ...
    return Scaffold(
           ...
           SingleChildScrollView(
            ...
            Expanded(
              child: GridView.count(
                ...
                physics: BouncingScrollPhysics(),
                children: [
                  WItemArrival(image: images[0], title: 'Smart Watches', price: '\$120.00'),
                  WItemArrival(image: images[1], title: 'Apple MacBook', price: '\$250.00'),
                  WItemArrival(image: images[2], title: 'Traveling Bags', price: '\$220.00'),
                  WItemArrival(image: images[3], title: 'New Sport Shoes', price: '\$300.00'),
                  WItemArrival(image: images[4], title: 'Bag', price: '\$120.00'),
                  WItemArrival(image: images[5], title: 'Black T-shirt', price: '\$180.00'),
                ],
              ),
            )
      ...
      drawer: Drawer(
        ...
        child: ListView(
          children: [
            ...
            const Align(
              ...
              child: Text.rich(
                  TextSpan(
                      text: 'Swip',style: TextStyle(color: AppColors.primary,fontWeight: FontWeight.bold,fontSize: 28),
                      children: [
                        TextSpan(
                            text: 'wide',style: TextStyle(
                          fontSize: 28,
        ...
        ListTile(
          ...
          title: Text("Rewards",style: TextStyle(color: AppColors.black,fontSize: 18,fontWeight: FontWeight.bold,fontFamily: 'MainFont'),),
          onTap: (){
            ...
            title: Text("Help",style: TextStyle(color: AppColors.black,fontSize: 18,fontWeight: FontWeight.bold,fontFamily: 'MainFont'),),
            onTap: (){
              Navigator.of(context).pop();
            },
            ),
            ListTile(
              ...
              title: Text("Contact Us",style: TextStyle(color: AppColors.black,fontSize: 18,fontWeight: FontWeight.bold,fontFamily: 'MainFont'),),
              onTap: (){
                Navigator.of(context).pop();
              },
            ),
            ListTile(
              ...
              title: Text("Privacy Policy",style: TextStyle(color: AppColors.black,fontSize: 18,fontWeight: FontWeight.bold,fontFamily: 'MainFont'),),
              onTap: (){
                Navigator.of(context).pop();
              },
            ),
            ListTile(
              ...
              title: Text("Logout",style: TextStyle(color: AppColors.black,fontSize: 18,fontWeight: FontWeight.bold,fontFamily: 'MainFont'),),
              onTap: (){
                Navigator.of(context).pop();
              },
            )
